...
public class Level1tiga extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level1tiga);
        ...
        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/Level%201%203_zpsdgrs2kt0.png")
                .into(img_Soal);
        ...
        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/w1_zps4gnjgkws.png")
                .into(img_A);

        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/w2_zpsvvpjsj3e.png")
                .into(img_B);

        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/w3_zpsyyoywl5i.png")
                .into(img_C);

        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/w4_zpsq5x0sl9z.png")
                .into(img_D);
    }
    ...
    public void onClick(View view) {
        ...
        if (view == img_B){
            Intent i = new Intent(Level1tiga.this, Level1empat.class);
            startActivity(i);
        }
        if (view == img_C){
