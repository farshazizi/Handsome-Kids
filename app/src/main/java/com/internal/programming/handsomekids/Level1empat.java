...
public class Level1empat extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level1empat);
        ...
        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/Level%201%204_zpsmwuv5rdp.png")
                .into(img_Soal);
        ...
        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/e1_zpstlahhsio.png")
                .into(img_A);

        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/e2_zpsfykvjayf.png")
                .into(img_B);

        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/e3_zpskjjw5weu.png")
                .into(img_C);

        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/e4_zpso0d9sxad.png")
                .into(img_D);
    }
    ...
    public void onClick(View view) {
        if (view == img_A){
            Intent i = new Intent(Level1empat.this, Level1lima.class);
            startActivity(i);
        }
        if (view == img_B){
