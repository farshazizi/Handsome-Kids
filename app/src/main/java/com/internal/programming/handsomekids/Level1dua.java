...
public class Level1dua extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level1dua);
        ...
        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/Level%201%202_zpsrc5thaze.png")
                .into(img_Soal);
        ...
        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/q1_zpsxdmronnu.png")
                .into(img_A);

        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/q2_zpsd288rpjz.png")
                .into(img_B);

        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/q3_zpsdboodcok.png")
                .into(img_C);

        Picasso.with(this)
                .load("http://i38.photobucket.com/albums/e111/Azizi_Farsha/q4_zpswqkqynim.png")
                .into(img_D);
    }
    ...
    public void onClick(View view) {
        if (view == img_A){
            Intent i = new Intent(Level1dua.this, Level1tiga.class);
            startActivity(i);
        }
        if (view == img_B){
